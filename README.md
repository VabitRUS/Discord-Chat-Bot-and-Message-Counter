#Discord Чат-Бот с Функцией ИИ и подсчетом сообщений
...
Примечание: Автор кода не несет отвественности, за любые действия других человек, при взаимодействии с кодом, предоставляемые 
